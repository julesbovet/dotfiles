...
" {{{
    ...
    hi Search                                    guibg=#779999          gui=none
    ...
    hi SignColumn       guifg=#9fafaf           guibg=#202020           gui=none
    ...
    " == TagBar plugin ==
    hi TagbarAccessPublic guifg=#789123
    hi TagbarAccessProtected guifg=#789123
    hi TagbarAccessPrivate guifg=#789123
    
    " == C++ ==
    hi Namespace guifg=#86aabb
    hi cppcout guifg=#86aa66
    hi cppcerr guifg=#c87472
