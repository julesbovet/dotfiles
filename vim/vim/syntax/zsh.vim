...
syn match   zshQuoted           '\\.'
syn match   zshColorRed		'\\033\[31m'
syn match   zshColorGreen	'\\033\[32m'
syn match   zshColorYellow	'\\033\[33m'
syn match   zshColorBlue	'\\033\[34m'
syn region  zshString           matchgroup=zshStringDelimiter start=+"+ end=+"+
                                \ contains=zshQuoted,@zshDerefs,@zshSubst,zshColorGreen,zshColorYellow,zshColorRed,zshColorBlue
syn region  zshString           matchgroup=zshStringDelimiter start=+'+ end=+'+
...
syn region  zshPOSIXString      matchgroup=zshStringDelimiter start=+\$'+
                                \ end=+'+ contains=zshQuoted,zshColorGreen,zshColorYellow,zshColorRed,zshColorBlue
...
hi def link zshDereferencing    Function
if s:zsh_syntax_variables =~ 'short\|all'
...
hi def link zshSubst            Function
hi def link zshMathSubst        zshSubst
hi def link zshOldSubst         zshSubst
hi def link zshSubstDelim       zshSubst
hi def link zshColorBlue	Type
hi def link zshColorRed		PreProc
hi def link zshColorGreen	String
hi def link zshColorYellow	Number
hi def link zshCommentTitle	PreProc
