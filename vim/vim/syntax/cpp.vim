...
syn keyword cppcout		cout
syn keyword cppcerr		cerr
...
syn match cppNamespace 		"[a-zA-Z0-9]*::\|namespace.*$"
...
" HiLink cppSTL			cppstdcolor
  ...
  HiLink cppcout		cppcoutcolor
  HiLink cppcerr		cppcerrcolor
  HiLink myfixes 		Todo
