...
if exists("b:javascript_fold")
    ...
    syntax region  javaScriptFuncName       contained matchgroup=javaScriptFuncName start=/{{{/ end=/}}}/ contains=javaScriptLineComment,javaScriptComment nextgroup=javaScriptFuncBlock skipwhite skipempty
